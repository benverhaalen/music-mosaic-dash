	...
	theme: {
		...
		extend: {
			...
			animation: {
				...
				'music-wave-1': 'music-wave 0.8s ease-in-out infinite',
				'music-wave-2': 'music-wave 0.9s ease-in-out 0.1s infinite',
				'music-wave-3': 'music-wave 0.7s ease-in-out 0.2s infinite',
